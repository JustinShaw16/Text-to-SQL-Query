...
\copy preliminary FROM '/common/home/jfs199/Desktop/Project01/NJMortgage2017.csv' DELIMITER ',' CSV HEADER;

ALTER TABLE preliminary ADD COLUMN IF NOT EXISTS temp_id SERIAL;
